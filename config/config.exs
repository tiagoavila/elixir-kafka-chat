...
config :elixir_kafka_chat,
  ecto_repos: [ElixirKafkaChat.Repo]

# Configures the endpoint
config :elixir_kafka_chat, ElixirKafkaChatWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [
    formats: [html: ElixirKafkaChatWeb.ErrorHTML, json: ElixirKafkaChatWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: ElixirKafkaChat.PubSub,
  live_view: [signing_salt: "bhax8dqK"]
...
config :elixir_kafka_chat, ElixirKafkaChat.Mailer, adapter: Swoosh.Adapters.Local
